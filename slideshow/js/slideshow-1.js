...
var createSlideshow = function () {
    ...
    var timer, speed, play = true, nodes, img, stopSlideShow, displayNextImage, setPlayText;
    ...
    return {
        ...
        setSpeed: function () {
            $("speed").onclick = createSlideshow.getSpeed(speed);
        },
        getSpeed: function () {
            ...
            window.console.log("Current Slideshow Speed: " + speed);
            speed = parseInt(window.prompt("Current Slideshow Speed: " + speed + "\n" + "Enter desired speed."), 10);
            if (speed < 0 || isNaN(speed)) {
                speed = parseInt(window.prompt("Current Slideshow Speed: " + speed + "\n" + "Please enter a valid speed and resume slideshow."), 10);
            } else {
                window.alert("Speed reset. Please resume slideshow.");
            }
        }
    };
};
